function posterior_probabilities = infer_policy_trj_without_free_without_smll_prbs_lst_n_gms_mx_2(data_filename,last_games_no)
...
max_level = 2; %the highest level possible
